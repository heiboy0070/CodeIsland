...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "session_click_action": "Session Click Action",
        "session_click_action_desc": "What happens when clicking a session card",
        "click_action_terminal": "Activate Terminal",
        "click_action_message_input": "Open Message Input",
        "shortcuts": "Shortcuts",
    ...
    private static let zh: [String: String] = [
        ...
        "session_click_action": "Session 点击行为",
        "session_click_action_desc": "点击 Session 卡片时的操作",
        "click_action_terminal": "激活终端",
        "click_action_message_input": "打开消息输入",
        "shortcuts": "快捷键",
